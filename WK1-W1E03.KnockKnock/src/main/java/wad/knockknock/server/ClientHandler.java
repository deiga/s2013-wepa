...
public class ClientHandler extends Thread {
    ...
    private void handleRequest() throws IOException {
        ...
        int index = new Random().nextInt(Jokes.NAMES.length);

        waitForMessage(scanner, out, "Who's there?", Jokes.NAMES[index],
                "You are supposed to ask: \"Who's there?\"");

        String expectedMessage = Jokes.NAMES[index] + " who?";
        waitForMessage(scanner, out, expectedMessage, Jokes.ANSWERS[index] + " Bye.",
