...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <form action="${pageContext.request.contextPath}/app/aircrafts/" method="POST">
                ...
                <li>${aircraft.name}
                    <c:choose>
                        <c:when test="${aircraft.airport == null}">
                            ...
                            <form action="${pageContext.request.contextPath}/app/aircrafts/${aircraft.id}/airports" method="POST">
        ...
        <p><a href="${pageContext.request.contextPath}/app/airports/">Airports</a></p>
    </body>
</html>
