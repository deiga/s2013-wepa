...
public class EntityTester {
    ...
    private void hasTableAnnotation(String className) {
        assertNotNull("Class " + className + " should have annotation " + Table.class.getName() + ".", Reflex.reflect(className).cls().getAnnotation(Table.class));
    }
